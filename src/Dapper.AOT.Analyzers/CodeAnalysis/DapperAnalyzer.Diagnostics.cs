...
partial class DapperAnalyzer
{
    internal sealed class Diagnostics : DiagnosticsBase
    {
        ...
        UnusableTypeHandler = LibraryWarning("DAP055", "Type-handler cannot be used",
            "'{0}' cannot be used as a type-handler for '{1}': {2}. The registration is ignored, and values of '{1}' bind as if it were not there"),
        RuntimeTypeHandlerRegistration = LibraryWarning("DAP054", "Type-handler registered at runtime",
