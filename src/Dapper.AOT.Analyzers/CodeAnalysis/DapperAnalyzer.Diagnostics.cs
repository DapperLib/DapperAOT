...
partial class DapperAnalyzer
{
    internal sealed class Diagnostics : DiagnosticsBase
    {
        ...
        ExecVariable = SqlWarning("DAP212", "EXEC with composed SQL", "EXEC with composed SQL may be susceptible to SQL injection; consider EXEC sp_executesql, taking care to fully parameterize the composed query"),
        VariableValueNotConsumed = SqlWarning("DAP213", "Variable used before declared", "Variable {0} has a value that is not consumed"),
