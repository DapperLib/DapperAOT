...
partial class DapperAnalyzer
{
    internal sealed class Diagnostics : DiagnosticsBase
    {
        ...
        ScalarVariableUsedAsTable = SqlError("DAP207", "Scalar used like table", "Scalar variable {0} is used like a table", true),
        TableVariableUsedAsScalar = SqlError("DAP208", "Table used like scalar", "Table-variable {0} is used like a scalar", true),
        TableVariableAccessedBeforePopulate = SqlError("DAP209", "Table used before populate", "Table-variable {0} is accessed before it populated", true),
        VariableAccessedBeforeAssignment = SqlError("DAP210", "Variable used before assigned", "Variable {0} is accessed before it is assigned a value", true),
        VariableAccessedBeforeDeclaration = SqlError("DAP211", "Variable used before declared", "Variable {0} is accessed before it is declared", true),
        ExecComposedSql = SqlWarning("DAP212", "EXEC with composed SQL", "EXEC with composed SQL may be susceptible to SQL injection; consider EXEC sp_executesql, taking care to fully parameterize the composed query", true),
        VariableValueNotConsumed = SqlWarning("DAP213", "Variable used before declared", "Variable {0} has a value that is not consumed", true),
        ...
        TableVariableOutputParameter = SqlWarning("DAP215", "Variable used before declared", "Table variable {0} cannot be used as an output parameter"),
