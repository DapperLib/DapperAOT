...
partial class DapperInterceptorGenerator
{
    internal sealed class Diagnostics : DiagnosticsBase
    {
        ...
        internal static readonly DiagnosticDescriptor
            InterceptorsGenerated = LibraryHidden("DAP000", "Interceptors generated", "Dapper.AOT handled {0} of {1} enabled call-sites ({2} unsupported API, {3} refused with diagnostics, {4} skipped silently) using {5} interceptors, {6} commands and {7} readers"),
