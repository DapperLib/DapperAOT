...
public static class Foo
{
    static async Task SomeCode(DbConnection connection, string bar, bool isBuffered)
    {
        ...
        _ = connection.Query<object>("def", obj, buffered: true, commandType: CommandType.Text);
        ...
        _ = connection.Query<dynamic>("def", obj, buffered: true, commandType: CommandType.Text);
        ...
        await foreach (var item in connection.QueryUnbufferedAsync<object>("def", obj, commandType: CommandType.Text)) { }
        ...
        await foreach (var item in connection.QueryUnbufferedAsync<dynamic>("def", obj, commandType: CommandType.Text)) { }
