...
file static class DapperGeneratedInterceptors
{
    ...
    {
        // Query, TypedResult, HasParameters, SingleRow, StoredProcedure, AtLeastOne
        ...
        return global::Dapper.DapperAotExtensions.Command<object?>(cnn, transaction, sql, global::System.Data.CommandType.StoredProcedure, commandTimeout ?? -1, CommandFactory0.Instance).QueryFirst<global::Foo.Customer>(param, RowFactory0.Instance);
    ...
    internal static global::Foo.Customer? QueryFirstOrDefault1(this global::System.Data.IDbConnection cnn, string sql, object param, global::System.Data.IDbTransaction transaction, int? commandTimeout, global::System.Data.CommandType? commandType)
    {
        ...
        return global::Dapper.DapperAotExtensions.Command<object?>(cnn, transaction, sql, global::System.Data.CommandType.StoredProcedure, commandTimeout ?? -1, CommandFactory0.Instance).QueryFirstOrDefault<global::Foo.Customer>(param, RowFactory0.Instance);
    ...
    internal static global::Foo.Customer QuerySingle2(this global::System.Data.IDbConnection cnn, string sql, object param, global::System.Data.IDbTransaction transaction, int? commandTimeout, global::System.Data.CommandType? commandType)
    {
        ...
        return global::Dapper.DapperAotExtensions.Command<object?>(cnn, transaction, sql, global::System.Data.CommandType.Text, commandTimeout ?? -1, CommandFactory1.Instance).QuerySingle<global::Foo.Customer>(param, RowFactory0.Instance);
    ...
    internal static global::Foo.Customer? QuerySingleOrDefault3(this global::System.Data.IDbConnection cnn, string sql, object param, global::System.Data.IDbTransaction transaction, int? commandTimeout, global::System.Data.CommandType? commandType)
    {
        ...
        return global::Dapper.DapperAotExtensions.Command<object?>(cnn, transaction, sql, global::System.Data.CommandType.StoredProcedure, commandTimeout ?? -1, DefaultCommandFactory).QuerySingleOrDefault<global::Foo.Customer>(param, RowFactory0.Instance);
    ...
    {
        // Query, Async, TypedResult, HasParameters, SingleRow, StoredProcedure, AtLeastOne
        // takes parameter: <anonymous type: int Foo, string bar>
        // parameter map: (everything)
        // returns data: global::Foo.Customer
        global::System.Diagnostics.Debug.Assert(!string.IsNullOrWhiteSpace(sql));
        ...
        return global::Dapper.DapperAotExtensions.Command<object?>(cnn, transaction, sql, global::System.Data.CommandType.StoredProcedure, commandTimeout ?? -1, CommandFactory0.Instance).QueryFirstAsync<global::Foo.Customer>(param, RowFactory0.Instance, default);
    ...
    internal static global::System.Threading.Tasks.Task<global::Foo.Customer>? QueryFirstOrDefaultAsync5(this global::System.Data.IDbConnection cnn, string sql, object param, global::System.Data.IDbTransaction transaction, int? commandTimeout, global::System.Data.CommandType? commandType)
    {
        ...
        return global::Dapper.DapperAotExtensions.Command<object?>(cnn, transaction, sql, global::System.Data.CommandType.StoredProcedure, commandTimeout ?? -1, CommandFactory0.Instance).QueryFirstOrDefaultAsync<global::Foo.Customer>(param, RowFactory0.Instance, default);
    ...
    internal static global::System.Threading.Tasks.Task<global::Foo.Customer> QuerySingleAsync6(this global::System.Data.IDbConnection cnn, string sql, object param, global::System.Data.IDbTransaction transaction, int? commandTimeout, global::System.Data.CommandType? commandType)
    {
        ...
        return global::Dapper.DapperAotExtensions.Command<object?>(cnn, transaction, sql, global::System.Data.CommandType.Text, commandTimeout ?? -1, CommandFactory1.Instance).QuerySingleAsync<global::Foo.Customer>(param, RowFactory0.Instance, default);
    ...
    internal static global::System.Threading.Tasks.Task<global::Foo.Customer>? QuerySingleOrDefaultAsync7(this global::System.Data.IDbConnection cnn, string sql, object param, global::System.Data.IDbTransaction transaction, int? commandTimeout, global::System.Data.CommandType? commandType)
    {
        ...
        return global::Dapper.DapperAotExtensions.Command<object?>(cnn, transaction, sql, global::System.Data.CommandType.StoredProcedure, commandTimeout ?? -1, DefaultCommandFactory).QuerySingleOrDefaultAsync<global::Foo.Customer>(param, RowFactory0.Instance, default);
