    ...
    file static class DapperGeneratedInterceptors
    {
        ...
        private sealed class RowFactory0 : global::Dapper.RowFactory<global::Foo.MyType>
        {
            ...
            public override global::Foo.MyType Read(global::System.Data.Common.DbDataReader reader, global::System.ReadOnlySpan<int> tokens, int columnOffset, object? state)
            {
                ...
                for (int i = 0; i < tokens.Length; i++)
                {
                    ...
                    {
                        case 0:
                            result.C = reader.IsDBNull(columnOffset) ? (global::CustomClass?)null : TypeHandler0.Parse(reader, columnOffset, handlerTokens[i]);
                            break;
                        case 1:
                            result.C = reader.IsDBNull(columnOffset) ? (global::CustomClass?)null : TypeHandler0.Parse(reader, columnOffset, handlerTokens[i]);
                            break;
        ...
        private sealed class CommandFactory0 : CommonCommandFactory<object?> // <anonymous type: CustomClass Param>
        {
            ...
            public override void AddParameters(in global::Dapper.UnifiedCommand cmd, object? args)
            {
                ...
                if (typed.Param is null) TypeHandler0.SetNullValue(p);
                else TypeHandler0.SetValue(p, typed.Param);
                ps.Add(p);
            ...
            public override void UpdateParameters(in global::Dapper.UnifiedCommand cmd, object? args)
            {
                var typed = Cast(args, static () => new { Param = default(global::CustomClass) }); // expected shape
                var ps = cmd.Parameters;
                if (typed.Param is null) TypeHandler0.SetNullValue(ps[0]);
                else TypeHandler0.SetValue(ps[0], typed.Param);
        ...
        private sealed class CommandFactory1 : CommonCommandFactory<global::Foo.CommandParameters>
        {
            ...
            {
                var ps = cmd.Parameters;
                args.OutputValue = TypeHandler0.Parse(ps[0]);
        ...
        private static readonly global::Dapper.IDbValueHandler<global::CustomClass> TypeHandler0 = new global::CustomClassTypeHandler();
