...
namespace Dapper.AOT // interceptors must be in a known namespace
{
    file static class DapperGeneratedInterceptors
    {
        ...
        private sealed class CommandFactory0 : CommonCommandFactory<object?> // <anonymous type: int Foo>
        {
            ...
            private static Pool<global::System.Data.Common.DbBatchCommand>? BatchStorage;
        ...
        private abstract class CommandFactory1 : CommonCommandFactory<object?> // <anonymous type: int Foo, string bar>
        {
            ...
            protected abstract ref Pool<global::System.Data.Common.DbBatchCommand>? BatchStorage {get;}
            ...
            internal sealed class Cached0 : CommandFactory1
            {
                ...
                protected override ref Pool<global::System.Data.Common.DbBatchCommand>? BatchStorage => ref s_BatchStorage;
                private static Pool<global::System.Data.Common.DbBatchCommand>? s_BatchStorage;
