...
#pragma warning restore CS0618
		...
		finally
		{
			...
			if (__dapper__command is not null)
			{
				...
				__dapper__command = global::System.Threading.Interlocked.Exchange(ref s___dapper__command_Samples_Async_SinglePooled_input_cs_TaskAsync_8, __dapper__command);
	...
	public async partial global::PooledAwait.PooledValueTask<global::SomeType> ValueTaskAsync(global::System.Data.Common.DbConnection connection, int id, string name)
	{
		...
		try
		{
			...
			// prepare command (excluding parameter values)
			if ((__dapper__command = global::System.Threading.Interlocked.Exchange(ref s___dapper__command_Samples_Async_SinglePooled_input_cs_ValueTaskAsync_11, null)) is null)
			{
				__dapper__command = __dapper__CreateCommand(connection!);
			}
			else
...
#pragma warning restore CS0618
		...
		finally
		{
			...
			{
				__dapper__command.Connection = default;
				__dapper__command = global::System.Threading.Interlocked.Exchange(ref s___dapper__command_Samples_Async_SinglePooled_input_cs_ValueTaskAsync_11, __dapper__command);
				__dapper__command?.Dispose();
			}
			if (__dapper__close) connection?.Close();
		}
	...
	public async partial global::PooledAwait.PooledTask<global::SomeType> TaskWithCancellationAsync(global::System.Data.Common.DbConnection connection, int id, string name, global::System.Threading.CancellationToken cancellation)
	{
		...
		try
		{
			...
			// prepare command (excluding parameter values)
			if ((__dapper__command = global::System.Threading.Interlocked.Exchange(ref s___dapper__command_Samples_Async_SinglePooled_input_cs_TaskWithCancellationAsync_14, null)) is null)
			{
				__dapper__command = __dapper__CreateCommand(connection!);
			}
			else
...
#pragma warning restore CS0618
		...
		finally
		{
			...
			{
				__dapper__command.Connection = default;
				__dapper__command = global::System.Threading.Interlocked.Exchange(ref s___dapper__command_Samples_Async_SinglePooled_input_cs_TaskWithCancellationAsync_14, __dapper__command);
				__dapper__command?.Dispose();
			}
			if (__dapper__close) connection?.Close();
		}
	...
	public async partial global::PooledAwait.PooledValueTask<global::SomeType> ValueWithCancellationTaskAsync(global::System.Data.Common.DbConnection connection, int id, string name, global::System.Threading.CancellationToken cancellation)
	{
		...
		try
		{
			...
			// prepare command (excluding parameter values)
			if ((__dapper__command = global::System.Threading.Interlocked.Exchange(ref s___dapper__command_Samples_Async_SinglePooled_input_cs_ValueWithCancellationTaskAsync_17, null)) is null)
			{
				__dapper__command = __dapper__CreateCommand(connection!);
			}
			else
...
#pragma warning restore CS0618
		...
		finally
		{
			...
			{
				__dapper__command.Connection = default;
				__dapper__command = global::System.Threading.Interlocked.Exchange(ref s___dapper__command_Samples_Async_SinglePooled_input_cs_ValueWithCancellationTaskAsync_17, __dapper__command);
				__dapper__command?.Dispose();
			}
			if (__dapper__close) connection?.Close();
		}
