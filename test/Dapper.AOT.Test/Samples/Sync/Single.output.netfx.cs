...
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Single.output.netfx.cs(605,21): error CS0161: 'Test.Scalar(DbConnection, int, string)': not all code paths return a value
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Single.output.netfx.cs(609,8): warning CS0219: The variable '__dapper__close' is assigned but its value is never used
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Single.output.netfx.cs(622,25): error CS0103: The name '__dapper__CreateCommand' does not exist in the current context
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Single.output.netfx.cs(635,3): error CS1524: Expected catch or finally
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Single.output.netfx.cs(635,4): error CS1513: } expected
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Single.output.netfx.cs(635,4): error CS1513: } expected
