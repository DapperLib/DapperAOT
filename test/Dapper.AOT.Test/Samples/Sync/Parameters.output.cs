...
// Samples\Sync\Parameters.input.cs(18,72): error CS1003: Syntax error, ',' expected
// Output code has 4 diagnostics from 'Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Parameters.output.cs':
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Parameters.output.cs(18,21): error CS0161: 'Test.ReturnViaReturn(DbConnection, int, string, DateTime)': not all code paths return a value
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Parameters.output.cs(18,21): error CS0759: No defining declaration found for implementing declaration of partial method 'Test.ReturnViaReturn(DbConnection, int, string, DateTime)'
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Parameters.output.cs(106,21): error CS0759: No defining declaration found for implementing declaration of partial method 'Test.RecordsAffectedViaReturn(DbConnection, int, string, DateTime)'
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Parameters.output.cs(212,22): error CS0759: No defining declaration found for implementing declaration of partial method 'Test.ReturnAndRecordsAffectedViaOut(DbConnection, int, string, DateTime, int, int)'
