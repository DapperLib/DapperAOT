...
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Parameters.output.netfx.cs(17,21): error CS0161: 'Test.ReturnViaReturn(DbConnection, int, string, DateTime)': not all code paths return a value
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Parameters.output.netfx.cs(17,21): error CS0759: No defining declaration found for implementing declaration of partial method 'Test.ReturnViaReturn(DbConnection, int, string, DateTime)'
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Parameters.output.netfx.cs(101,21): error CS0759: No defining declaration found for implementing declaration of partial method 'Test.RecordsAffectedViaReturn(DbConnection, int, string, DateTime)'
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Parameters.output.netfx.cs(203,22): error CS0759: No defining declaration found for implementing declaration of partial method 'Test.ReturnAndRecordsAffectedViaOut(DbConnection, int, string, DateTime, int, int)'
