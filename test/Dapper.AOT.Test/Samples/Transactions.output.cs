...
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Transactions.output.cs(281,8): error CS0019: Operator '??' cannot be applied to operands of type 'DbConnection' and 'bool'
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Transactions.output.cs(283,5): error CS0019: Operator '??' cannot be applied to operands of type 'DbConnection' and 'void'
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Transactions.output.cs(283,5): error CS0201: Only assignment, call, increment, decrement, await, and new object expressions can be used as a statement
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Transactions.output.cs(312,25): error CS0019: Operator '??' cannot be applied to operands of type 'DbConnection' and 'void'
// Dapper.AOT\Dapper.CodeAnalysis.CommandGenerator\Transactions.output.cs(312,25): error CS0201: Only assignment, call, increment, decrement, await, and new object expressions can be used as a statement
